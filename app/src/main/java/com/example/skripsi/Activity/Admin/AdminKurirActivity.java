...
import com.example.skripsi.Activity.Koor.DaftarKurir.TambahDataKurirActivity;
...
public class AdminKurirActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_kurir);
        ...
        fabTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AdminKurirActivity.this, TambahDataKurirActivity.class));
            }
        });
    }
    ...
    public void retrieveData(){
        ...
        tampilData.enqueue(new Callback<ResponModel>() {
            ...
            public void onResponse(Call<ResponModel> call, Response<ResponModel> response) {
                ...
                adData = new AdapterData(AdminKurirActivity.this, listData);
            ...
            public void onFailure(Call<ResponModel> call, Throwable t) {
                Toast.makeText(AdminKurirActivity.this,"Gagal Menghubungi Server : "+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}